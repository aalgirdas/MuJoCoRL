...
if __name__ == "__main__":
    ...
    MODEL_SAVE_PATH = os.path.join(script_dir, "mujoco_cartpole_ppo_model_2D")  # MODEL_SAVE_PATH =  r"D:\Webots_examples\webots_mujoco\code_py\mujoco_cartpole_ppo_model"
    ...
    TOTAL_TIMESTEPS = 10000000  # Increase for better performance
